...
<div id="nonVegitrianMenu">
  ...
  <h4 class="row alert alert-success">
    ...
    <div class="card-header" id="headingOne">
      <h5 class="mb-0 text-center">
        <button class="btn " data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <strong class="productCategoryName">Product Category</strong>
        </button>
      </h5>
    </div>
  ...
  <div class="card shadow">
    <div class="card-header" id="headingThree">
      <h5 class="mb-0 text-center">
        <button class=" btn text-center collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <strong class="productCategoryName">Product Category</strong>
        </button>
      </h5>
    </div>
